...
// If that file is absent (fresh clone, CI without secrets) the release build
...
android {
    namespace = "com.classscheduler.classscheduler"
    ...
    defaultConfig {
        ...
        applicationId = "com.classscheduler.classscheduler"
